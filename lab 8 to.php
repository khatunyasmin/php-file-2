                     ...
                     // echo (strtotime("+1 week 5days 7hors "));
    ...
    echo "<h2>Q13.Write a program to calculate and print the factorial of a number using a for loop.</h2>";
       ...
       echo "The factorial of $n is:".$p."<br>";*/
           ...
           /* $o=4;
            ...
            echo "<h3 style='color:black;'>Q22.Write a String function.</h3>";


                print(strtoupper("MY NAME IS Yasmin Khatun"));

                echo"<br>";

                print(strtolower("MY NAME IS Yasmin Khatun"));
                echo"<br>";
                print(ucfirst("my NAME IS yasmin Khatun"));
                echo"<br>";
                print(ucwords("MY nAME IS yasmin khatun"));


                      echo "<h3 style='color:black;'>Q24.date&time.</h3>";
                      ...
                      echo"<br>";
                      echo "The day is ".date("l", mktime(0,0,0,05,4,2023)) . "<br><br>";


                      echo "<h3 style='color:black;'>Q25.strtotime.</h3>";
